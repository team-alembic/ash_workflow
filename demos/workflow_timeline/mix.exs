defmodule WorkflowTimeline.MixProject do
  use Mix.Project

  def project do
    [
      app: :workflow_timeline,
      version: "0.1.0",
      elixir: "~> 1.14",
  ...
  def application do
    [
      mod: {WorkflowTimeline.Application, []},
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind workflow_timeline", "esbuild workflow_timeline"],
      "assets.deploy": [
        "tailwind workflow_timeline --minify",
        "esbuild workflow_timeline --minify",
        "phx.digest"
      ]
    ]
  end
