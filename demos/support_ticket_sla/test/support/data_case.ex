defmodule SupportTicketSla.DataCase do
  @moduledoc """
  ...
  using do
    quote do
      use Oban.Testing, repo: SupportTicketSla.Repo, prefix: "public"

      import SupportTicketSla.DataCase
    end
  end

  setup _tags do
    :ok = Sandbox.checkout(SupportTicketSla.Repo)
    :ok
  end
  ...
  def set_datetime(record, field, value) do
    ...
    {1, _} =
      SupportTicketSla.Repo.update_all(
