defmodule OrderFulfilment.DataCase do
  @moduledoc """
  ...
  using do
    quote do
      use Oban.Testing, repo: OrderFulfilment.Repo, prefix: "public"

      import OrderFulfilment.DataCase
    end
  end

  setup _tags do
    :ok = Sandbox.checkout(OrderFulfilment.Repo)
    :ok
  end
  ...
  def run_workflow_triggers(resource) do
    ...
    Oban.drain_queue(queue: :fulfilment, with_recursion: true, with_scheduled: true)
  end
