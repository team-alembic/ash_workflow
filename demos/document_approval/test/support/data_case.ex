defmodule DocumentApproval.DataCase do
  @moduledoc """
  ...
  using do
    quote do
      use Oban.Testing, repo: DocumentApproval.Repo, prefix: "public"

      import DocumentApproval.DataCase
    end
  end

  setup _tags do
    :ok = Sandbox.checkout(DocumentApproval.Repo)
    :ok
  end
  ...
  def set_datetime(record, field, value) do
    ...
    {1, _} =
      DocumentApproval.Repo.update_all(
